...
class Dob extends AbstractWidget {
     ...
     * @param array $data
     */
    public function __construct(Context $context, Address $addressHelper, CustomerMetadataInterface $customerMetadata, Date $dateElement, FilterFactory $filterFactory, array $data = []) {
    ...
    public function _construct(){
        parent::_construct();
        $this->setTemplate('Jhonathan_Customer::widget/dob.phtml');
    }
    ...
    public function getHtmlExtraParams():string {
        ...
        $validators['validate-date'] = ['dateFormat' => $this->getDateFormat()];
    ...
    public function getDateFormat():string {
        ...
        return preg_replace('/[^MmDdYy\/\.\-]/', '', $dateFormat);
    }
